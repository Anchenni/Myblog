...
def accounts_register(request):
    ...
    #         send_mail(
    # 'Email Confirmation from Anwar',
    # message,
    # settings.EMAIL_HOST_USER,
    # [user.email], 
    # fail_silently=False,)
            #print('current_site.domain ===', current_site.domain, 'uid ==', urlsafe_base64_encode(force_bytes(user.pk)), 'token', account_activation_token.make_token(user))
